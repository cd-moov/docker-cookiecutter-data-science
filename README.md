...
![docker local dev](https://s3-us-west-1.amazonaws.com/manifold-public-no-vpn/torus_local_dev.png =50x)
...
1. Install Requirements:
    ...
    - [Cookiecutter](http://cookiecutter.readthedocs.org/en/latest/installation.html) (Python Package):
    ``` bash
    $ conda install cookiecutter
    ```
2. Run the cookiecutter docker data science template to scaffold your new project:
    ``` bash
    $ cookiecutter https://github.com/cd-moov/docker-cookiecutter-data-science.git
    ```
4. Answer all of the cookiecutter prompts for project name, description, etc.
...
└── environment.yml      <- The requirements file for reproducing the analysis environment, e.g.
                             generated with `pip freeze > requirements.txt`.ini           
```
...
Cookiecutter:
- [Blog](https://medium.com/manifold-ai/torus-a-toolkit-for-docker-first-data-science-bddcb4c97b52) to original version of this cookiecutter template
